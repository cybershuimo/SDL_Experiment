...
class Dot
{
    public:
        ...
        void render( int camX, int camY, SDL_Rect* sourceClip );
...
void Dot::render( int camX, int camY, SDL_Rect* sourceClip )
{
    //Show the dot relative to the camera
    gFooTexture.render( mPosX - camX, mPosY - camY, sourceClip );
}
...
bool loadMedia()
{
    ...
    if( !gFooTexture.loadFromFile( "14_animated_sprites_and_vsync/foo.png" ) )
    {
